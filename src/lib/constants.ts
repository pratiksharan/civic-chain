...
export const DEPT_MAP: Record<string, DeptInfo> = {
  garbage: {
    ...
    portal: 'https://bbmp.gov.in/en/citizen-services', deepLink: 'https://bbmp.gov.in/en/citizen-services', hasDeepLink: true,
    ...
    guide: [
      { step: 'Open BBMP Sahaaya portal', tip: 'Go to bbmp.gov.in/en/citizen-services — the official BBMP citizen grievance portal.' },
  ...
  pothole: {
    ...
    guide: [
      { step: 'Open BBMP Sahaaya portal', tip: 'Go to bbmp.gov.in/en/citizen-services — the official BBMP grievance portal.' },
  ...
  water: {
    ...
    portal: 'https://bwssb.gov.in', deepLink: 'https://bwssb.gov.in', hasDeepLink: true,
  ...
  electricity: {
    ...
    portal: 'https://bescom.karnataka.gov.in', deepLink: 'https://bescom.karnataka.gov.in', hasDeepLink: true,
  ...
  noise: {
    ...
    portal: 'https://kspcb.karnataka.gov.in', deepLink: 'https://kspcb.karnataka.gov.in', hasDeepLink: true,
  ...
  encroachment: {
    ...
    guide: [
      { step: 'Open BBMP Sahaaya portal', tip: 'Go to bbmp.gov.in/en/citizen-services — Town Planning division handles encroachment.' },
  ...
  health: {
    ...
    guide: [
      ...
      { step: 'Or open BBMP Sahaaya portal for formal complaint', tip: 'Go to bbmp.gov.in/en/citizen-services for non-urgent formal complaints.' },
  ...
  general: {
    ...
    portal: 'https://pgportal.gov.in', deepLink: 'https://pgportal.gov.in', hasDeepLink: true,
...
export const ESC_CHAIN: EscalationLevel[] = [
  {
    ...
    contact: { phone: '080-22221111', email: 'wardofficer@bbmp.gov.in', portal: 'https://bbmp.gov.in/en/citizen-services', address: 'BBMP Ward Office — check your ward number at bbmp.gov.in', howTo: 'Visit your ward office directly or submit via the BBMP Sahaaya portal at bbmp.gov.in/en/citizen-services.' },
  },
  {
    ...
    contact: { phone: '080-22975000', email: 'zonalofficer@bbmp.gov.in', portal: 'https://bbmp.gov.in/en/citizen-services', address: 'BBMP Zonal Office — 5 zones: East, West, South, Mahadevapura, Dasarahalli.', howTo: 'Send a formal letter or email to the Zonal Commissioner with your complaint reference number.' },
  },
  {
